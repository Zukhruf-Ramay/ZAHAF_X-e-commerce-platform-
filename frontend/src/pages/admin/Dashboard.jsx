  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      const refundedAmount = orders
        ...
        .reduce((sum, o) => sum + (o.refundedAmount || o.totalAmount || 0), 0)
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-10">
      <div className="mb-8">
        <div className="flex items-center justify-between flex-wrap gap-3">
          <div>
            ...
            <p className="text-gray-500 mt-3">Welcome back, {user?.name || 'Admin'}!</p>
          </div>
          {isAdmin && (
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 sm:gap-6 mb-8">
        <div className="bg-white rounded-xl shadow-md p-6">
          ...
          <Link to="/admin/products" className="text-sm text-blue-500 mt-3 inline-block hover:underline">Manage Products →</Link>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-md p-6">
          ...
          <Link to="/admin/orders" className="text-sm text-green-500 mt-3 inline-block hover:underline">Manage Orders →</Link>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-md p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-red-600">Rs. {stats.refundedAmount.toLocaleString()}</p>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-md p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-purple-600">Rs. {stats.netRevenue.toLocaleString()}</p>
            </div>
      ...
      <div className="bg-white rounded-xl shadow-md overflow-hidden">
        <div className="px-6 py-4 border-b flex justify-between items-center">
          ...
          <Link to="/admin/orders" className="text-blue-500 hover:text-blue-600 text-sm font-semibold">View All →</Link>
        </div>
            ...
            <tbody className="divide-y divide-gray-200">
              {recentOrders.map(order => (
                <tr key={order._id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-6 py-4 text-sm font-semibold">Rs. {order.totalAmount?.toLocaleString()}</td>
                  ...
                  <td className="px-6 py-4">
                    <Link to={`/admin/orders/${order._id}`} className="text-blue-600 hover:text-blue-800 text-sm font-medium">View Details</Link>
                  </td>
                </tr>
              ))}
